...
socket.on("ukazArduinu", function(štUkaza) {
        ...
        if (štUkaza == "5") {
            ...
            board.digitalWrite(9, board.HIGH); // zapišemo +5V na pin 8
        ...
        if (štUkaza == "9") {
         ...
         if (štUkaza == "9") {
            ...
            board.digitalWrite(13, board.HIGH); // zapišemo +5V na pin 8

        }
        
        if (štUkaza == "8") {

            board.digitalWrite(12, board.LOW); // zapišemo +5V na pin 8

        }
         if (štUkaza == "8") {

            board.digitalWrite(8, board.LOW); // zapišemo +5V na pin 8

        }
         if (štUkaza == "8") {

            board.digitalWrite(9, board.LOW); // zapišemo +5V na pin 8

        }
         if (štUkaza == "8") {

            board.digitalWrite(13, board.LOW); // zapišemo +5V na pin 8
