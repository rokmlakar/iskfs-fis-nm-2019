...
var faktor =0.4; // faktor, ki doloca hitrost doseganja želenega stanja
var pwm = 0;
...
var pošljiStaticnoSporociloPrekoVticnika = function() {}; // funkcija za pošiljanje staticnega sporocila

board.on("ready", function(){
    console.log("Plošca pripravljena");
    ...
    io.sockets.on("connection", function(socket){
        ...
        socket.emit("pošljiStaticnoSporociloPrekoVticnika", "Stre??nik povezan, plošca pripravljena.")
    ...
    pošljiStaticnoSporociloPrekoVticnika = function (value) {
...
function startKontrolniAlgoritem (parametri) {
    if (kontrolniAlgoritemVkljucen == 0) {
        ...
        console.log("Vkljucen kontrolni algoritem št. " + parametri.štKontrolnegaAlg)
        pošljiStaticnoSporociloPrekoVticnika("Kontrolni algoritem št. " + parametri.štKontrolnegaAlg + " zagnan | " + json2txt(parametri));
    }
...
function stopKontrolniAlgoritem () {
    ...
    pošljiStaticnoSporociloPrekoVticnika("Kontrolni algoritem zaustavljen.");
};
